...
def check_fall(agent, obs, pitch_threshold=45, roll_threshold=45, adjust=False, initial_pose=None, initial_rotation=None):
    ...
    if is_fall and adjust:
        ...
        position_offset = np.random.uniform(low=-1, high=1, size=3)
...
while env.simulation_app.is_running():
    ...
    if i % 100 == 0:
        ...
        is_fall = check_fall(agent, cur_obs, adjust=False, initial_pose=start_position, initial_rotation=start_rotation)
