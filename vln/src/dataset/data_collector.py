...
class dataCollector:
    ...
    def collect_and_send_data(self, step_time, env, camera_list, camera_pose_dict, end_list, add_rgb_subframes=True, finish_flag=False):
