...
class DiscreteFlashDPEvalSingleScanEnv(BaseSingleScanEnv):
            ...
            while True:
                ...
                for exe_step_i in range(self.eval_config.EVAL.len_traj_act):
                    ...
                    if test_verbose:
                        ...
                        plt.imsave('logs/test0.jpg', outputs_dict[0]['rgb'])
                        print(f"observation has been saved to logs/test0.jpg")
