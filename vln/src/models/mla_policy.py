...
from vln.src.models.encoders.mlnet_clip_encoders import CLIPEncoder, VlnResnetDepthEncoder
...
class MLANet(nn.Module):
    ...
    def __init__(
        ...
        self.low_state_encoder = encoders.build_rnn_state_encoder(
        ...
        self.high_state_encoder = encoders.build_rnn_state_encoder(
            input_size=rnn_input_size,
            hidden_size=state_encoder_hidden_size,
        ...
        self.action_decoder = encoders.build_rnn_state_encoder(
    ...
    def _forward(
        ...
        self.step_cnt += 1
        return x, rnn_states_out # x: [bs, 512], rnn_states_out: [bs, 3, 512]
