...
#################### update from VLFM ###########################
    ...
    def warm_up(self,warm_step =50):
        ...
        while self.step < warm_step:
            self.step += 1
            if (self.step % 50 == 0):
                self.env.step(actions=env_actions, add_rgb_subframes=False, render=False, analysis_time=True)
                ...
                # fps_start = fps_end
        self.env.step(actions=env_actions, add_rgb_subframes=True, render=False, analysis_time=True)   
