...
#             -v /ssd/xiaxinyuan/checkpoints/models--timm--vit_large_patch16_384.augreg_in21k_ft_in1k:/root/.cache/huggingface/hub/models--timm--vit_large_patch16_384.augreg_in21k_ft_in1k:ro \
#             -v /ssd/xiaxinyuan/checkpoints/demo_e200.ckpt:/isaac-sim/GRUtopia/vlmaps/vlmaps/lseg/checkpoints/demo_e200.ckpt:ro \
...
#             -v /ssd/xiaxinyuan/code/w61-grutopia/logs_docker_object:/isaac-sim/GRUtopia/logs_docker:rw \
