...
sudo docker run -it --network host \
  ...
  -v /g0433_data/xiaxinyuan/checkpoints/models--timm--vit_large_patch16_384.augreg_in21k_ft_in1k:/root/.cache/huggingface/hub/models--timm--vit_large_patch16_384.augreg_in21k_ft_in1k:rw \
  -v /g0433_data/xiaxinyuan/checkpoints/demo_e200.ckpt:/isaac-sim/GRUtopia/vlmaps/vlmaps/lseg/checkpoints/demo_e200.ckpt:ro \
