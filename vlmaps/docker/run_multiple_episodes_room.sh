...
SPLITS=("val_unseen")
OUTPUT_DIR="multi_gpu_list_room_$NUM_GPUS"  # 相对路径，例如: multi_gpu_list_val_unseen_7
EXPERIMENTS_PER_GPU=1
BASE_CONTAINER_NAME="isaac-sim-xxy"
IMAGE_NAME="xxy_new:3.4"
FILE_NAME="valid_paths/val_unseen/room_id.txt"
...
for GPU in "${GPU_LIST[@]}"; do
    for ((i=0; i<$EXPERIMENTS_PER_GPU; i++)); do
        ...
        sudo docker run --name ${CONTAINER_NAME} \
            ...
            -v /ssd/xiaxinyuan/code/w61-grutopia/logs_docker_room:/isaac-sim/GRUtopia/logs_docker:rw \
