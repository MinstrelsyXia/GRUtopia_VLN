...
class Context:
    ...
    def run(self):
        ...
        for i in range(len(target_path_key_list)):
            ...
            eval_logger.info(f"split: {split_map[path_key]}")
            eval_logger.info(f"scan: {the_scan}")
            eval_logger.info(f"trajectory_id_episode_id: {path_key}")
            eval_logger.info(f"data: {data}")
